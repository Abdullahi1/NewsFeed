package com.example.newsfeed.ui.fragments.feedsection.science
...
import com.example.newsfeed.databinding.FragmentScienceBinding
...
@AndroidEntryPoint
class ScienceStoryFragment : ScopedFragment() {
...
//        val topStoryRepository  = TopStoryRepositoryImpl(db.topStoryDao(),feedDataSource)
    ...
    companion object {
         ...
         * @return A new instance of fragment ScienceStoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            ScienceStoryFragment()
    }
}
